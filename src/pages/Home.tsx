...
const capabilities = [
  ...
  { number: "02", label: "Power & Grid", title: "Grid Modernization & High Voltage Diagnostics", body: "Substation automation, harmonic mitigation, and electrical safety standards across Kerala." },
  { number: "03", label: "AI & VLSI", title: "Neuromorphic Chips & Edge AI Hardware", body: "Brain-inspired analog VLSI and semiconductor acceleration with Digital University Kerala." },
  { number: "04", label: "ESG Compliance", title: "MSME Decarbonization & BRSR Reporting", body: "Carbon footprint accounting, clean biogas power, and SEBI sustainability disclosures." },
  { number: "05", label: "Knowledge Series", title: "ConsulTalks & Masterclasses", body: "Regular technical roundtables on engineering ethics, commercial bidding, and patent advisory." },
  { number: "06", label: "Tender Syndicates", title: "Multi-Disciplinary Project Syndicates", body: "Collaborative consortium bidding for large-scale public and private infrastructure RFPs." },
];
